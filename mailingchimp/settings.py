"""
Django settings for mailingchimp project.
...
SECRET_KEY = '(y9573d+5(3e&cfe%yf3@vy788o11z6k5p5r14119b@a0lk_&i'
...
ROOT_URLCONF = 'mailingchimp.urls'
...
WSGI_APPLICATION = 'mailingchimp.wsgi.application'
